    ...
    stages { 
        stage('Build') { 
            steps { 
                ...
                bat "docker build -t flaskjenkins:v1 ." 
            } 
        } 
        stage('Run') { 
            steps { 
                ...
                bat "docker run -d -p 5000:5000 --name mycontainer flaskjenkins:v1" 
                //with -d runs the container in detached mode,  
                    //meaning it runs in the background, and you get your terminal back immediately. 
                //Without -d runs in the foreground,  
                    //terminal shows container logs and is “blocked” by the container process. 
            } 
        } 
    } 
    post { 
